    ...
    confirmDialog(
      ...
      async () => {
        try {
          ...
          await Promise.all([DB.importParents(exercises), DB.importParents(workouts)])
    ...
    confirmDialog(
      ...
      async () => {
        try {
          ...
          await DB.importParents(measurements)
